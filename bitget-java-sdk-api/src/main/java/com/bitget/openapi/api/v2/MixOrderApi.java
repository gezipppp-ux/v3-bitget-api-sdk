...
public interface MixOrderApi {
    ...
    Call<ResponseResult> ordersHistory(@QueryMap Map<String, Object> paramMap);

    @GET("/api/v2/mix/order/orders-pending")
    Call<ResponseResult> ordersPending(@QueryMap Map<String, Object> paramMap);
    ...
    Call<ResponseResult> ordersPlanPending(@QueryMap Map<String, Object> paramMap);

    @GET("/api/v2/mix/order/orders-plan-history")
    Call<ResponseResult> ordersPlanHistory(@QueryMap Map<String, Object> paramMap);


    // trader
    @POST("/api/v2/copy/mix-trader/order-close-positions")
    Call<ResponseResult> traderOrderClosePositions(@Body Map<String, Object> paramMap);

    @GET("/api/v2/copy/mix-trader/order-current-track")
    Call<ResponseResult> traderOrderCurrentTrack(@QueryMap Map<String, Object> paramMap);

    @GET("/api/v2/copy/mix-trader/order-history-track")
    Call<ResponseResult> traderOrderHistoryTrack(@QueryMap Map<String, Object> paramMap);

    @POST("/api/v2/copy/mix-follower/close-positions")
    Call<ResponseResult> followerClosePositions(@Body Map<String, Object> paramMap);

    @GET("/api/v2/copy/mix-follower/query-current-orders")
    Call<ResponseResult> followerQueryCurrentOrders(@QueryMap Map<String, Object> paramMap);

    @GET("/api/v2/copy/mix-follower/query-history-orders")
    Call<ResponseResult> followerQueryHistoryOrders(@QueryMap Map<String, Object> paramMap);
}
