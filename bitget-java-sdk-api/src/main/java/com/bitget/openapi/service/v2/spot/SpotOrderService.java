...
public class SpotOrderService {
    ...
    public ResponseResult batchCancelOrder(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(spotOrderApi.batchCancelOrder(paramMap).execute().body());
    }

    public ResponseResult unfilledOrders(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(spotOrderApi.unfilledOrders(paramMap).execute().body());
    }

    public ResponseResult historyOrders(Map<String, Object> paramMap) throws IOException {
    ...
    public ResponseResult currentPlanOrder(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(spotOrderApi.currentPlanOrder(paramMap).execute().body());
    }

    public ResponseResult historyPlanOrder(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(spotOrderApi.historyPlanOrder(paramMap).execute().body());
    }


    public ResponseResult traderOrderCloseTracking(Map<String, Object> paramMap) throws IOException {
