...
public class SpotWalletService {
    ...
    public ResponseResult withdrawalList(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(spotWalletApi.withdrawalList(paramMap).execute().body());
    }

    public ResponseResult depositList(Map<String, Object> paramMap) throws IOException {
