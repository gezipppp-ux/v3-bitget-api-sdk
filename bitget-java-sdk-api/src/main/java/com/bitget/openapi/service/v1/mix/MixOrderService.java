...
public class MixOrderService {
    ...
    public ResponseResult current(Map<String, Object> paramMap) throws IOException {
    ...
    public ResponseResult traderCloseOrder(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixOrderApi.traderCloseOrder(paramMap).execute().body());
    }

    public ResponseResult traderCurrentOrders(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixOrderApi.traderCurrentOrders(paramMap).execute().body());
    }

    public ResponseResult traderHistoryTrack(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixOrderApi.traderHistoryTrack(paramMap).execute().body());
    }

    public ResponseResult followerCloseByTrackingNo(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixOrderApi.followerCloseByTrackingNo(paramMap).execute().body());
    }

    public ResponseResult followerOrder(Map<String, Object> paramMap) throws IOException {
        return ResponseUtils.handleResponse(mixOrderApi.followerOrder(paramMap).execute().body());
    }

    public ResponseResult followerHistoryOrders(Map<String, Object> paramMap) throws IOException {
